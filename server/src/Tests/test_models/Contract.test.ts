...
describe('contract model', () => {
    ...
    it('should throw an error if admin is missing', async () => {
    ...
    it('should throw an error if clinicMarkup is missing', async () => {
    ...
    it('should throw an error if clinicMarkup is below the minimum value', async () => {
    ...
    it('should throw an error if clinicMarkup is above the maximum value', async () => {
        const contractWithInvalidMarkup = {
            doctor: new Types.ObjectId(),
            admin: new Types.ObjectId(),
            clinicMarkup: 105,
